...
public class DatabaseTest {
    ...
    private final Class mDbHelperClass = GrocerylistDbHelper.class;
    ...
    public void create_database_test() throws Exception{
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                GrocerylistContract.GrocerylistEntry.TABLE_NAME, tableNameCursor.getString(0));
    ...
    public void insert_single_record_test() throws Exception{
        ...
        testValues.put(GrocerylistContract.GrocerylistEntry.COLUMN_ITEM_NAME, "test name");
        testValues.put(GrocerylistContract.GrocerylistEntry.COLUMN_WEIGHT, 99);
